export default function Home() {
  return (
    <>
      <main className="w-screen h-screen flex justify-evenly flex-col items-center">

        {/* titulo */}
        <header className="flex flex-col items-center gap-2">
          <h1 className='text-5xl font-bold my-shadow mt-3 pl-8 pr-8 pt-8'>WEB RÁDIO</h1>
        ...
        {/* versículo + imagem */}
      <div className="h-auto flex flex-col items-center bg-amber-950 rounded-lg m-4 p-4">
